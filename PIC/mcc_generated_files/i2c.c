...
extern void Print_String(uint8_t const *BStr, uint8_t chln);
/**
...
void I2C_Initialize(void) {
    ...
    SSP1CON3 = 0x00;
    // Baud Rate Generator Value: SSP1ADD 31;   
    SSP1ADD = 0x1F;
...
//            Print_String("S_MASTER_RESTART$", 1);
...
//            Print_String("S_MASTER_SEND_ADDR_10BIT_LSB$", 1);
...
//            Print_String("S_MASTER_10BIT_RESTART$", 1);
...
//            Print_String("S_MASTER_SEND_ADDR$", 1);
...
//            Print_String("S_MASTER_SEND_DATA$", 1);
...
//            Print_String("S_MASTER_ACK_ADDR$", 1);
...
//            Print_String("S_MASTER_RCV_DATA$", 1);
...
//            Print_String("S_MASTER_ACK_RCV_DATA$", 1);
...
//            Print_String("S_MASTER_RCV_STOP$", 1);
